...
const Modal = props => {
  ...
  return (
    <CSSTransition in={isOpen} timeout={300} classNames="tr-modal-overlay" mountOnEnter unmountOnExit>
      <div className="modal-overlay">
        <CSSTransition in={isOpen} timeout={300} appear={true} classNames="tr-modal">
          <div className="modal">
