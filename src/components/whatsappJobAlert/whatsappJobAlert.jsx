    ...
    return (
      <div className="job-alert card">
        ...
        <div className="job-alert__form">
          <input className={error ? "input--error": ""} type="tel" name="phone" placeholder="Enter whatsapp number" onChange={this.onPhoneEnter} />
          <Button className="job-alert__btn" text="get updates" type="secondary" clickHandler={this.onPhoneSubmit} />
        </div>
