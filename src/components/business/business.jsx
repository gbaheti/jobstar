  ...
  return (
    <div className="business">
      <nav className="business-nav flex limit-width">
        ...
        <a className="business-link" href="http://blog.jobstar.in">
          Read Blog
        </a>
      </nav>
      <div className="business-home limit-width">
        <div className="business-home__content">
          <h1>
            Easiest way to find verified{" "}
            <span className="text--highlighted text--bold">
              part-time workers.
            </span>
          </h1>
          <p>
            We enable thousands of Indians to make money via part-time work
            online or offline.
          </p>
      ...
      <div className="business-about" id="about">
        <div className="business-about__description limit-width">
          ...
          <p>
            Jobstar is a crowdsourced hiring service with{" "}
            <span className="text--bold">thousands of verified workers</span>.
            We help individuals and businesses to create low cost{" "}
            <span className="text--bold">online + offline</span> part-time jobs
            to{" "}
            <span className="text--bold">
              increase sales, generate word of mouth, get better online ranking,
              do ground research, data creation, audit for quality assurance
            </span>{" "}
            and more. We are combining workers and employers to minimise
            publicity and marketing costs while at the same time providing money
            to everyday users.
          </p>
        </div>
            ...
            <ul className="advantages-list">
              <li className="advantages-list__item">
                ...
                <p>
                  ...
                  — only pay for the temp hires.
                </p>
              </li>
              <li className="advantages-list__item">
                <img src={check} alt="" />
                <p>
                  <span className="text--bold">Get instant results</span> once
                  your incentivized task goes live to our workforce.
                </p>
              </li>
              <li className="advantages-list__item">
                <img src={check} alt="" />
                <p>
                  <span className="text--bold">
                    Execute your job anywhere PAN India
                  </span>{" "}
                  — without worrying about creating a new team there.
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className="limit-width">
          ...
          <div className="business-stats__reviews flex--lg limit-width">
            <div className="review-card">
              <p>
                Jobstar has been a great resource to help us meet spikes in our
                demand during Maha Bachat sales — a previously unavailable
                solution that has allowed us a lot of flexibility in managing
                the headcount in our stores.
              </p>
              <h4>future group</h4>
            </div>
            <div className="review-card">
              <p>
                “Jobstar has helped us find the best users to figure out what
                our customers need and we’re now building products around that.”
              </p>
              <h4>spars studio</h4>
            </div>
          </div>
      ...
      <div className="business-contact">
        <div className="business-contact--limit">
          ...
          <p className="business-contact__desc">
            Call us at <span className="text--bold">8178818406</span> or email
            at <span className="text--bold">hey@jobstar.in</span>
          </p>
          ...
          <p className="business-contact__details">
            Please leave your contact details, we’ll be in touch within 24
            hours.
          </p>
        </div>
        ...
        <Button
          ...
          className="business-contact__cta"
        />
      </div>
    </div>
  );
